...
class Uri extends \Panada\Utilities\Factory
{
    ...
    public function fromServer()
    {
        ...
        $scriptName             = str_replace($this->frontController, '', $_SERVER['SERVER_NAME'].$_SERVER['SCRIPT_NAME']);
        $requestURI             = str_replace($this->frontController, '', $_SERVER['SERVER_NAME'].$_SERVER['REQUEST_URI']);
